                ...
                <div className='mt-10 mb-28 container mx-auto'>
                    <div class="flex justify-center flex-wrap max-w-5xl mx-auto">
                        ...
                        <div className='text-center p-5 rounded-full bg-white border-2 shadow-xl hover:scale-110 ease-linear duration-200 my-5 mx-3 w-72'>
                            ...
                            <div class="stat-title font-semibold">Production Countries</div>
                        ...
                        <div className='text-center p-5 rounded-full bg-white border-2 shadow-xl hover:scale-110 ease-linear duration-200 my-5 mx-3 w-72'>
                            ...
                            <div class="stat-title font-semibold">Total Feedbacks</div>
                        ...
                        <div className='text-center p-5 rounded-full bg-white border-2 shadow-xl hover:scale-110 ease-linear duration-200 my-5 mx-3 w-72'>
                            ...
                            <div class="stat-title font-semibold">Market Share</div>
                        ...
                        <div className='text-center p-5 rounded-full bg-white border-2 shadow-xl hover:scale-110 ease-linear duration-200 my-5 mx-3 w-72'>
                            ...
                            <div class="stat-title font-semibold">Customer</div>
                        ...
                        <div className='text-center p-5 rounded-full bg-white border-2 shadow-xl hover:scale-110 ease-linear duration-200 my-5 mx-3 w-72'>
                            ...
                            <div class="stat-title font-semibold">Company Growth</div>
